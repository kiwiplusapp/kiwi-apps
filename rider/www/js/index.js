/*
 * Licened to the Apache Software Foundation (ASF) under one
...
var APP_VERSION_IOS = "10.0.2";
var APP_VERSION_ANDROID = "10.0.2";
        ...
        if(route_polyline != null){
            ...
            duration: 1000,
                ...
                route_distance_duration_info_marker = map.addMarker({
                    ...
                    'disableAutoPan':true,
                    'draggable' : false,
                    'title' : intra_city_duration_text + "Tiempo estimado",
